                    ...
                    <div className="produtos">     
                            ...
                            {this.state.produtos.map((prod) =>{
                                    return(
                                        ...
                                        <div  className="produto" >
                                            ...
                                            <p className="precoNovo">{prod.precoNovo}</p>
                        ...
                        <div className="alinhaMobi">
                            <div className="produtoMobi">
                                ...
                                <div className="tenis">
                                    <img src={TenisPequeno} />
                                </div>
                                <p className="nomeProduto">Tenis couro Puma R698 Q4<br/>V2</p>
                                <img src={Star} className=""/>
                                <p className="precoAntigo">de R$ 299,00</p>
                                <p className="precoNovo">por R$ 399,00</p>
                                <p className="parcela">ou em 3x de R$ 133,00</p>
                                <div className="btn">
                                    <img className="car" src={Car}/> 
                                    <p className="textoBtn">comprar</p> 
                                </div>              
                            </div>
                            <div className="produtoMobi">
                                <div className="desconto">
                                    <img src={DescontoMobi} />
                                </div>
                                <div className="tenis">
                                    <img src={TenisPequeno} />
                                </div>
